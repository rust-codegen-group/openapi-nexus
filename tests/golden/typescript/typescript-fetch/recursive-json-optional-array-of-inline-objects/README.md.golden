...
This package provides a TypeScript/JavaScript client for the Optional Array of Inline Objects Test API. It uses the native [Fetch API](https://fetch.spec.whatwg.org/) for HTTP requests and works in both Node.js and browser environments.
...
```bash
npm install optional-array-of-inline-objects-test
```
...
{
  "dependencies": {
    "optional-array-of-inline-objects-test": "file:../../path/to/generated/package"
  }
}
```
...
```typescript
import { Configuration, DefaultApi } from 'optional-array-of-inline-objects-test';
...
```typescript
import { Configuration, Middleware } from 'optional-array-of-inline-objects-test';
...
```typescript
import { ResponseError, FetchError, RequiredError } from 'optional-array-of-inline-objects-test';
...
```typescript
import type { User, CreateUserRequest } from 'optional-array-of-inline-objects-test';
