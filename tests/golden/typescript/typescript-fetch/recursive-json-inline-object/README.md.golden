...
This package provides a TypeScript/JavaScript client for the Inline Object Test API. It uses the native [Fetch API](https://fetch.spec.whatwg.org/) for HTTP requests and works in both Node.js and browser environments.
...
```bash
npm install inline-object-test
```
...
{
  "dependencies": {
    "inline-object-test": "file:../../path/to/generated/package"
  }
}
```
...
```typescript
import { Configuration, DefaultApi } from 'inline-object-test';
...
```typescript
import { Configuration, Middleware } from 'inline-object-test';
...
```typescript
import { ResponseError, FetchError, RequiredError } from 'inline-object-test';
...
```typescript
import type { User, CreateUserRequest } from 'inline-object-test';
