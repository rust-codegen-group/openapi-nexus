...
This package provides a TypeScript/JavaScript client for the Complex Array Structure Test API. It uses the native [Fetch API](https://fetch.spec.whatwg.org/) for HTTP requests and works in both Node.js and browser environments.
...
```bash
npm install complex-array-structure-test
```
...
{
  "dependencies": {
    "complex-array-structure-test": "file:../../path/to/generated/package"
  }
}
```
...
```typescript
import { Configuration, DefaultApi } from 'complex-array-structure-test';
...
```typescript
import { Configuration, Middleware } from 'complex-array-structure-test';
...
```typescript
import { ResponseError, FetchError, RequiredError } from 'complex-array-structure-test';
...
```typescript
import type { User, CreateUserRequest } from 'complex-array-structure-test';
