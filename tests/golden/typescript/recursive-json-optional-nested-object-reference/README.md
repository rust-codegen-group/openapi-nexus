...
This package provides a TypeScript/JavaScript client for the Optional Nested Object Reference Test API. It uses the native [Fetch API](https://fetch.spec.whatwg.org/) for HTTP requests and works in both Node.js and browser environments.
...
```bash
npm install optional-nested-object-reference-test
```
...
{
  "dependencies": {
    "optional-nested-object-reference-test": "file:../../path/to/generated/package"
  }
}
```
...
```typescript
import { Configuration, DefaultApi } from 'optional-nested-object-reference-test';
...
```typescript
import { Configuration, Middleware } from 'optional-nested-object-reference-test';
...
```typescript
import { ResponseError, FetchError, RequiredError } from 'optional-nested-object-reference-test';
...
```typescript
import type { User, CreateUserRequest } from 'optional-nested-object-reference-test';
