...
This package provides a TypeScript/JavaScript client for the Inline Object with Array Test API. It uses the native [Fetch API](https://fetch.spec.whatwg.org/) for HTTP requests and works in both Node.js and browser environments.
...
```bash
npm install inline-object-with-array-test
```
...
{
  "dependencies": {
    "inline-object-with-array-test": "file:../../path/to/generated/package"
  }
}
```
...
```typescript
import { Configuration, DefaultApi } from 'inline-object-with-array-test';
...
```typescript
import { Configuration, Middleware } from 'inline-object-with-array-test';
...
```typescript
import { ResponseError, FetchError, RequiredError } from 'inline-object-with-array-test';
...
```typescript
import type { User, CreateUserRequest } from 'inline-object-with-array-test';
