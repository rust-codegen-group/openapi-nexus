...
This package provides a TypeScript/JavaScript client for the Optional Inline Object Test API. It uses the native [Fetch API](https://fetch.spec.whatwg.org/) for HTTP requests and works in both Node.js and browser environments.
...
```bash
npm install optional-inline-object-test
```
...
{
  "dependencies": {
    "optional-inline-object-test": "file:../../path/to/generated/package"
  }
}
```
...
```typescript
import { Configuration, DefaultApi } from 'optional-inline-object-test';
...
```typescript
import { Configuration, Middleware } from 'optional-inline-object-test';
...
```typescript
import { ResponseError, FetchError, RequiredError } from 'optional-inline-object-test';
...
```typescript
import type { User, CreateUserRequest } from 'optional-inline-object-test';
