...
This package provides a TypeScript/JavaScript client for the Nested Object Reference Test API. It uses the native [Fetch API](https://fetch.spec.whatwg.org/) for HTTP requests and works in both Node.js and browser environments.
...
```bash
npm install nested-object-reference-test
```
...
{
  "dependencies": {
    "nested-object-reference-test": "file:../../path/to/generated/package"
  }
}
```
...
```typescript
import { Configuration, DefaultApi } from 'nested-object-reference-test';
...
```typescript
import { Configuration, Middleware } from 'nested-object-reference-test';
...
```typescript
import { ResponseError, FetchError, RequiredError } from 'nested-object-reference-test';
...
```typescript
import type { User, CreateUserRequest } from 'nested-object-reference-test';
