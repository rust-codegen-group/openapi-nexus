...
This package provides a TypeScript/JavaScript client for the Optional Array of Referenced Types Test API. It uses the native [Fetch API](https://fetch.spec.whatwg.org/) for HTTP requests and works in both Node.js and browser environments.
...
```bash
npm install optional-array-of-referenced-types-test
```
...
{
  "dependencies": {
    "optional-array-of-referenced-types-test": "file:../../path/to/generated/package"
  }
}
```
...
```typescript
import { Configuration, DefaultApi } from 'optional-array-of-referenced-types-test';
...
```typescript
import { Configuration, Middleware } from 'optional-array-of-referenced-types-test';
...
```typescript
import { ResponseError, FetchError, RequiredError } from 'optional-array-of-referenced-types-test';
...
```typescript
import type { User, CreateUserRequest } from 'optional-array-of-referenced-types-test';
