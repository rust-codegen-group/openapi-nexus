//! Golden file tests for Java OkHttp generator
//!
//! These tests compare generated Java code against known-good golden files.
...
fn golden_dir() -> &'static Path {
    Path::new("tests/golden/java/java-okhttp")
}

const UPDATE_HINT: &str = "UPDATE_GOLDEN=1 cargo test --test golden_tests_java_okhttp";
    ...
    ($($test_name:ident: $spec_name:expr),* $(,)?) => {
        $(
            ...
            fn $test_name() {
                ...
                let generator = JavaOkhttpCodeGenerator::new(toml::value::Table::new());
                run_golden_test(
                    &generator,
                    golden_dir(),
                    $spec_name,
