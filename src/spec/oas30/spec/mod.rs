//! Structures used in parsing and navigating OpenAPI 3.0.x specifications.
//!
//! High-level structures include [`OpenApiV30Spec`], [`Components`] & [`Schema`].
