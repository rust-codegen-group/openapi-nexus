...
use super::config::KotlinOkhttpConfig;
...
#[derive(Debug, Clone)]
pub struct KotlinOkhttpCodeGenerator {
    config: KotlinOkhttpConfig,
}

impl KotlinOkhttpCodeGenerator {
    pub fn new(config: toml::value::Table) -> Self {
        Self {
            config: KotlinOkhttpConfig::from(config),
        }
    }
...
impl CodeGenerator for KotlinOkhttpCodeGenerator {
...
"#,
    ...
    FileInfo::project("build.gradle.kts".to_string(), content)
}
