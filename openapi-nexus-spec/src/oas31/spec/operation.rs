...
use super::{
    Callback, ErrorSpec, ExternalDoc, ObjectOrReference, OpenApiV31Spec, Parameter, RequestBody,
...
impl Operation {
    ...
    pub fn request_body(&self, spec: &OpenApiV31Spec) -> Result<Option<RequestBody>, ErrorSpec> {
    ...
    pub fn responses(&self, spec: &OpenApiV31Spec) -> BTreeMap<String, Response> {
        self.responses
            .iter()
            .flatten()
    ...
    pub fn parameters(&self, spec: &OpenApiV31Spec) -> Result<Vec<Parameter>, ErrorSpec> {
        let params = self
            .parameters
            .iter()
