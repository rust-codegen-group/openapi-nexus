...
use super::{
    Callback, Example, Header, Link, ObjectOrReference, Parameter, RequestBody, Response,
    SecurityScheme, schema::ObjectSchema, spec_extensions,
};

/// Holds a set of reusable objects for different aspects of the OAS (OAS 3.0: no pathItems).
