//! Script to generate OpenAPI YAML specification from the Enum Representation API

use clap::Parser;
use std::path::PathBuf;
use utoipa::OpenApi;

use openapi_nexus_examples_enum_repr::ApiDoc;
...
#[derive(Parser)]
#[command(about = "Generate OpenAPI YAML specification from the Enum Representation API")]
struct Args {
    /// Output directory for generated files
    #[arg(short, long, default_value = "tests/fixtures/valid/enum-repr")]
    output_dir: PathBuf,
}
...
fn main() {
    ...
    let yaml_path = args.output_dir.join("enum-repr.yaml");
