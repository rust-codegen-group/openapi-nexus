...
use super::{
    Callback, ErrorSpec, ExternalDoc, ObjectOrReference, OpenApiV30Spec, Parameter, RequestBody,
...
impl Operation {
    ...
    pub fn request_body(&self, spec: &OpenApiV30Spec) -> Result<Option<RequestBody>, ErrorSpec> {
    ...
    pub fn responses(&self, spec: &OpenApiV30Spec) -> BTreeMap<String, Response> {
        self.responses
            .iter()
            .flatten()
    ...
    pub fn parameters(&self, spec: &OpenApiV30Spec) -> Result<Vec<Parameter>, ErrorSpec> {
        Ok(self
            .parameters
            .iter()
