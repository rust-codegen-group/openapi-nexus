...
use super::{
    ErrorRef, Example, FromRef, MediaType, ObjectOrReference, ObjectSchema, OpenApiV30Spec, Ref,
    RefType, spec_extensions,
};

/// Parameter location.
/// OAS 3.0 allows path, query, header, cookie. Body and formData are accepted for lenient parsing of Swagger 2.0–style specs.
...
pub enum ParameterIn {
    ...
    Header,
    Cookie,
    /// Swagger 2.0 style; in OAS 3.0 use requestBody instead. Accepted for fixture compatibility.
    Body,
    /// Swagger 2.0 style (formData); in OAS 3.0 use requestBody with application/x-www-form-urlencoded. Accepted for fixture compatibility.
