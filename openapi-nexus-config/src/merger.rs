...
use openapi_nexus_common::Generator;
...
impl ConfigMerger {
    ...
    pub fn merge(
        ...
        let merged_global = GlobalConfig {
            ...
            generator: cli_global.generator,
        };
        ...
        let generator = merged_global
            .generator
            .unwrap_or(Generator::TypeScriptFetch);
        let resolved_global = merged_global.resolve(input, generator).map_err(|msg| {
